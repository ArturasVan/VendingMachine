...
namespace VendingMachine
{
    class Drink : Item
    {
        public Drink(string itemName, int itemPrice, string itemDescription, int itemQuantity)
        ...
        {
            return string.Format("You have drinked cold {0}", this.itemName);
        }
        ...
        public override string ToString()
        {
            ...
            return string.Format("[DRINK] ID: {0}, Name: {1}, Price: {2}, Description: {3}, Quantity: {4}",
